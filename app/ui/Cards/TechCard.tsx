...
const TechCard = ({
  ...
  return (
    <Card
      aria-label={Name}
      className="group relative flex items-center justify-center gap-4 rounded-2xl md:rounded-3xl bg-card p-4 transition duration-300 md:h-[300px] md:p-6  hover:bg-muted/50"
    >
      {/* Side glow Effect */}
