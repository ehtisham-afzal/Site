...
const NaveBarMobile = () => {
  ...
  return (
    <header className="flex h-16 w-11/12 items-center justify-between fixed bottom-8 right-[4.3%]  z-50 rounded-2xl border dark:border-accent bg-background/50 px-4 backdrop-blur-md md:hidden">
      <nav className="w-full">
        <div className="flex items-center justify-between gap-4">
          ...
          >
            ...
            <span className="sr-only">Aboute</span>
          </Link>
          <Link
            className={cn(
              "flex items-center justify-center w-full py-2 flex-1 rounded-md group text-light-gray",
          ...
          >
            ...
            <span className="sr-only">TechStack</span>
          </Link>
