...
const TechCard = ({
  ...
  return (
    <Card
      aria-label={Name}
      className="group relative flex items-center justify-center gap-4 rounded-3xl bg-card  p-4 transition duration-300 md:h-[300px] md:p-6  hover:bg-card-foreground/10"
    >
      {/* Side glow Effect */}
