...
const NaveBarMobile = () => {
  ...
  return (
    <header className="flex h-16 w-11/12 items-center justify-between fixed bottom-8 right-[4.3%]  z-50 rounded-2xl border border-primary bg-background/50 px-4 backdrop-blur-md md:hidden">
